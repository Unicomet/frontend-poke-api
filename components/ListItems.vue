...
<template>
  <div class="">
    <b-form inline class="justify-content-center">
      ...
      <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
        <b-form-input
          ...
          v-model="inputSearch"
          placeholder="Write..."
          @input="findPokemonsByPage()"
        >
        </b-form-input>
        <b-form-input
          v-show="selectedFilter != 'name'"
          id="range"
          v-model="inputSearch"
          type="range"
          min="0"
          :max="maxLimit"
          @change="findPokemonsByPage()"
        ></b-form-input>
      </b-input-group>
    ...
    <div class="row mt-5 justify-content-center w-100">
      ...
      >
        <img
          v-if="pokemon.pokemon_v2_pokemonsprites[0].sprites"
      ...
      if (this.maxLimits === null) {
        ...
        axios
          ...
          .then((response) => {
            ...
            this.maxLimits =
              response.data.data.pokemon_v2_pokemon_aggregate.aggregate.max;
    ...
    findPokemonsByPage(page = 1) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.totalItems =
            response.data.data.pokemon_v2_pokemon_aggregate.aggregate.count;
          console.log(
            "Total items: " + this.totalItems + "  Input: " + this.inputSearch
          );
